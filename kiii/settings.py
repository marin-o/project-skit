...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'INSECURE_KEY_$@$e!z9d(g+oz)sbk^%-!63fripp+ys4#*xb%m*m)19^r)1omf')
...
WSGI_APPLICATION = 'kiii.wsgi.application'
